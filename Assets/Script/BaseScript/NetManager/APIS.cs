...
namespace AssemblyCSharp
{
    public class APIS
    {
        ...
        public const string
            UPDATE_INFO_JSON_URL = "http://www.weipaigame.com/downLoad/appDown/update.xml"; //服务器上最新的软件版本信息存储文件

        //public const string UPDATE_INFO_JSON_URL = "http://127.0.0.1/test/update.xml";
        public const string chatSocketUrl = "39.108.222.120";

        //public const string chatSocketUrl = "192.168.0.112";
        //public const string socketUrl = "118.178.20.36";
        // public const string socketUrl = "192.168.0.203";
        //public const string socketUrl = "116.62.116.145";  //麻将
        //public const int socketPort = 10087;
        //public const string socketUrl = "192.168.0.134";          //朱佳灵    
        //public const int socketPort = 8600;

        public const string socketUrl = "103.239.245.151";//外网
        public const int socketPort = 8600;
        public static AddressFamily tcpFamily = AddressFamily.InterNetwork;
        //public const string socketUrl = "192.168.0.108";
        ...
        public const int MPPICKCARD_RESPONSE = 0x1000044; //明牌发牌4
        ...
        public const int BACK_BANKER = 0x100022; //返回叫庄
        public const int BACK_XIAZHU = 0x1000222; //返回下注
        public const int CHIPAI_REQUEST = 0x100003; //吃牌请求
        public const int CHIPAI_RESPONSE = 0x100018; //吃牌通知
        ...
        public const int HUPAIALL_RESPONSE = 0x100110; //游戏结束通知
        public const int GAMEOVERALL_RESPONSE = 0x100111; //全局结束通知
        ...
        public const int USER_SHOW_CARD = 0X0001114; //用户摊牌
        public const int REFRESH_PLAYER_STATE = 0X000115; //登录回调
        ...
        public const int MessageBox_Notice = 204; //聊天
        ...
        public const int ROOM_OPTION = 0x211212; //其他设备登录
        public const int SetRoomMark = 9001; //设置房间标志
    }
}