...
public class NcParticleEmit : NcEffectBehaviour
{
    ...
    public override string CheckProperty()
    {
        if (m_ParticlePrefab == null || (m_ParticlePrefab.GetComponent<ParticleEmitter>() == null &&
                                         m_ParticlePrefab.GetComponent<ParticleSystem>() == null))
    ...
    GameObject CreateAttachSharedParticle()
    {
        ...
        m_CreateGameObject.transform.position = new Vector3(Random.Range(-m_RandomRange.x, m_RandomRange.x) + newPos.x,
