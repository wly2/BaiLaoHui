...
public class NcDetachParent : NcEffectBehaviour
{
    ...
    public override string CheckProperty()
    {
        ...
        if (m_bFollowParentTransform && (GetComponent("NcCurveAnimation") != null ||
                                         GetComponent("NcRotation") != null || GetComponent("Animation") != null) ||
    ...
    // Function --------------------------------------------------------------------
    public void SetDestroyValue(bool bParentHideToStart, bool bStartDisableEmit, float fSmoothDestroyTime,
        bool bSmoothHide, bool bMeshFilterOnlySmoothHide)
    {
    ...
    void Update()
    {
        ...
        {
            if (m_bParentHideToStartDestroy)
                if (m_ParentGameObject == null || !IsActive(m_ParentGameObject))
                    StartDestroy();
        }
