...
public class NcAddForce : NcEffectBehaviour
{
    ...
    void AddForce()
    {
        ...
        {
            // Random pos
            Vector3 addForce = new Vector3(Random.Range(-m_RandomRange.x, m_RandomRange.x) + m_AddForce.x,
                Random.Range(-m_RandomRange.y, m_RandomRange.y) + m_AddForce.y,
                Random.Range(-m_RandomRange.z, m_RandomRange.z) + m_AddForce.z);
