...
public class NcAutoDestruct : NcEffectBehaviour
{
    ...
    // Create ---------------------------------------------------------------------------
    public static NcAutoDestruct CreateAutoDestruct(GameObject baseGameObject, float fLifeTime, float fDestroyTime,
    ...
    void FixedUpdate()
    {
        ...
        else if (m_CollisionType == CollisionType.WORLD_Y && transform.position.y <= m_fDestructPosY)
            bDestect = true;
