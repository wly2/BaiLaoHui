...
public class NcSpriteTexture : NcEffectBehaviour
{
    ...
    public override string CheckProperty()
    {
        ...
        if ((m_NcSpriteFactoryPrefab == null || m_NcSpriteFactoryPrefab.GetComponent<NcSpriteFactory>() == null) &&
            (GetComponent<NcSpriteFactory>() == null))
    ...
    {
        if (!UpdateFactoryInfo(nSpriteFactoryIndex))
            return;
    ...
    public void SetFrameIndex(int nFrameIndex)
    {
        ...
        if (m_NcSpriteFrameInfos == null)
            return;
        m_nFrameIndex = (m_NcSpriteFrameInfos.Length == 0
            ? 0
            : (m_NcSpriteFrameInfos.Length <= m_nFrameIndex ? m_NcSpriteFrameInfos.Length - 1 : m_nFrameIndex));
    }
