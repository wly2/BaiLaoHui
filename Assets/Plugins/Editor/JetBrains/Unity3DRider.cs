...
namespace Plugins.Editor.JetBrains
{
  ...
  public static class RiderPlugin
  {
    ...
    private static void InitRiderPlugin()
    {
      ...
      Log(LoggingLevel.Info,
        "Rider plugin initialized. You may change the amount of Rider Debug output via Edit -> Preferences -> Rider -> Logging Level");
      Initialized = true;
    }
  ...
  ""attach_allowed"": ""{4}""
    ...
    private static bool CallRider(string args)
    {
      ...
      else
      {
        ...
        Log(LoggingLevel.Verbose,
          string.Format("{2}{0}{2}" + " {1}", proc.StartInfo.FileName, proc.StartInfo.Arguments, "\""));
      }
 ...
 - With 4.5 Rider may show ambiguous references in UniRx.";
      ...
      SelectedLoggingLevel =
        (LoggingLevel) EditorGUILayout.EnumPopup(new GUIContent("Logging Level", loggingMsg), SelectedLoggingLevel);
