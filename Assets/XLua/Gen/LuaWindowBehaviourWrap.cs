...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaWindowBehaviourWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(LuaWindowBehaviour);
			Utils.BeginObjectRegister(type, L, translator, 0, 1, 0, 0);
			
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ShowExitConfirmation", _m_ShowExitConfirmation);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ShowExitConfirmation(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.ShowExitConfirmation(  );
