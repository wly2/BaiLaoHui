...
namespace XLua.CSObjectWrap
{
    ...
    public class WindowUITypeWrap
    {
		public static void __Register(RealStatePtr L)
        {
		    ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
		    Utils.BeginObjectRegister(typeof(WindowUIType), L, translator, 0, 0, 0, 0);
			Utils.EndObjectRegister(typeof(WindowUIType), L, translator, null, null, null, null, null);
			
			Utils.BeginClassRegister(typeof(WindowUIType), L, null, 14, 0, 0);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "None", WindowUIType.None);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "LogOn", WindowUIType.LogOn);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Reg", WindowUIType.Reg);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "GameServerEnter", WindowUIType.GameServerEnter);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "GameServerSelect", WindowUIType.GameServerSelect);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "RoleInfo", WindowUIType.RoleInfo);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "GameLevelMap", WindowUIType.GameLevelMap);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "GameLevelDetail", WindowUIType.GameLevelDetail);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "GameLevelVictory", WindowUIType.GameLevelVictory);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "GameLevelFail", WindowUIType.GameLevelFail);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "WorldMap", WindowUIType.WorldMap);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "WorldMapFail", WindowUIType.WorldMapFail);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "TestWindow", WindowUIType.TestWindow);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "__CastFrom", __CastFrom);
            
            Utils.EndClassRegister(typeof(WindowUIType), L, translator);
        }
        ...
        static int __CastFrom(RealStatePtr L)
		{
            ...
            {
                translator.PushWindowUIType(L, (WindowUIType)LuaAPI.xlua_tointeger(L, 1));
            }
            else if(lua_type == LuaTypes.LUA_TSTRING)
            {
			    if (LuaAPI.xlua_is_eq_str(L, 1, "None"))
                {
                    translator.PushWindowUIType(L, WindowUIType.None);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "LogOn"))
                {
                    translator.PushWindowUIType(L, WindowUIType.LogOn);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Reg"))
                {
                    translator.PushWindowUIType(L, WindowUIType.Reg);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "GameServerEnter"))
                {
                    translator.PushWindowUIType(L, WindowUIType.GameServerEnter);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "GameServerSelect"))
                {
                    translator.PushWindowUIType(L, WindowUIType.GameServerSelect);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "RoleInfo"))
                {
                    translator.PushWindowUIType(L, WindowUIType.RoleInfo);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "GameLevelMap"))
                {
                    translator.PushWindowUIType(L, WindowUIType.GameLevelMap);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "GameLevelDetail"))
                {
                    translator.PushWindowUIType(L, WindowUIType.GameLevelDetail);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "GameLevelVictory"))
                {
                    translator.PushWindowUIType(L, WindowUIType.GameLevelVictory);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "GameLevelFail"))
                {
                    translator.PushWindowUIType(L, WindowUIType.GameLevelFail);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "WorldMap"))
                {
                    translator.PushWindowUIType(L, WindowUIType.WorldMap);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "WorldMapFail"))
                {
                    translator.PushWindowUIType(L, WindowUIType.WorldMapFail);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "TestWindow"))
                {
                    translator.PushWindowUIType(L, WindowUIType.TestWindow);
                }
				else
                {
                    return LuaAPI.luaL_error(L, "invalid string for WindowUIType!");
                }
            }
            else
            {
                return LuaAPI.luaL_error(L, "invalid lua type for WindowUIType! Expect number or string, got + " + lua_type);
            }
