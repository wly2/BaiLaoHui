...
public class MagicBeamScript : MonoBehaviour
{
    ...
    [Header("Prefabs")] public GameObject[] beamLineRendererPrefab;
    ...
    {                                
        ...
        {
            beamStart =
                Instantiate(beamStartPrefab[currentBeam], new Vector3(0, 0, 0), Quaternion.identity) as GameObject;
            beamEnd = Instantiate(beamEndPrefab[currentBeam], new Vector3(0, 0, 0), Quaternion.identity) as GameObject;
            beam =
                Instantiate(beamLineRendererPrefab[currentBeam], new Vector3(0, 0, 0), Quaternion.identity) as
                    GameObject;
    ...
    void ShootBeamInDir(Vector3 start, Vector3 dir)
    {
        ...
        RaycastHit hit;
        end = Physics.Raycast(start, dir, out hit)
            ? hit.point - (dir.normalized * beamEndOffset)
